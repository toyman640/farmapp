...
urlpatterns = [
    ...
    path('cow-mortality-record-view/<slug>', views.cow_motrec_view, name='cow_motrec_view'),
    path('cow-culling-record-view/<slug>', views.cow_cullrec_view, name='cow_cullrec_view'),
    ...
    path('goat-mortality-record-view/<slug>', views.goat_motrec_view, name='goat_motrec_view'),
    ...
    path('goat-cull-record-view/<slug>', views.goat_cullrec_view, name='goat_cullrec_view'),
    path('pig-cull-record-view/<slug>', views.pig_cullrec_view, name='pig_cullrec_view'),
    path('pig-mortality-record-view/<slug>', views.pig_motrec_view, name='pig_motrec_view'),
    ...
    path('sheep-mortality-record-view/<slug>', views.sheep_motrec_view, name='sheep_motrec_view'),
    path('sheep-sale-record-view/<int:abt_id>', views.sheep_salerec_view, name='sheep_salerec_view'),
    path('sheep-cull-record-view/<slug>', views.sheep_cullrec_view, name='sheep_cullrec_view'),
    ...
    # path('notification', views.ping_light, name='ping_light'),
